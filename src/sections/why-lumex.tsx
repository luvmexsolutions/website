...
import { whyLumexContent } from '@/content/why-lumex';

export function WhyLumex() {
  return (
    <SectionWrapper id="why-lumex" className="relative border-t border-surface-border/40">
